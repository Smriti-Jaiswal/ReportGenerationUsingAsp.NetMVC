...
app.controller('myCtrl', ['$http', '$scope', 'fileUpload', function ($http, $scope, fileUpload) {
    ...
    $scope.isValidTab1 = function () {
        ...
        if ($scope.ddlsalstd != "" && $scope.ddlsalstd != null && $scope.txtfname != "" && $scope.txtfname != null && $scope.txtpersonalcontact != "" && $scope.txtpersonalcontact != null &&
             ...
             $scope.ddlcourse != "" && $scope.ddlcourse != null && $scope.ddlintake != "" && $scope.ddlintake != null &&
    ...
    $scope.ShowTab5 = function () {
        ...
        $scope.tabpanel3 = false;
        $scope.tabpanel4 = false;
        $scope.tabpanel5 = true;

        $scope.TabPanel1_B = false;
        $scope.TabPanel2_B = false;
        $scope.TabPanel3_B = false;
        $scope.TabPanel4_B = false;
        $scope.TabPanel5_B = true;
    ...
    $scope.CrsChange = function () {
        ...
        var httpreq = {
            method: 'POST',
            url: 'stdnew_new_offshore.aspx/GetIntakeData',
            headers: {
    ...
    $scope.IntChange = function () {
        ...
        var httpreq = {
            method: 'POST',
            url: 'stdnew_new_offshore.aspx/GetFeesData',
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'dataType': 'json'
            },
            data: { countryid: '58CD6215-43ED-4B2F-8EAD-47CA744D6C17', crsid: $scope.ddlcourse, intid: $scope.ddlintake, passid: $scope.passid }
        }
        $http(httpreq).success(function (response) {
    ...
    $scope.CntryChange = function () {
        ...
        var httpreq = {
            method: 'POST',
            url: 'stdnew_new_offshore.aspx/GetStateData',
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'dataType': 'json'
            },
            data: { countryid: '58CD6215-43ED-4B2F-8EAD-47CA744D6C17' }
        }
        $http(httpreq).success(function (response) {
        ...
        var httpreq1 = {
            method: 'POST',
            url: 'stdnew_new_offshore.aspx/GetCountryData',
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'dataType': 'json'
            },
    ...
    $scope.fetchStudentData = function () {
        ...
        if ($scope.passid.length > 0) {
            ...
            var httpreq = {
                method: 'POST',
                url: 'stdnew_new_offshore.aspx/GetStudentData',
                headers: {
                    'Content-Type': 'application/json; charset=utf-8',
                    'dataType': 'json'
                },
    ...
    $scope.FormDataSubmit = function () {
        ...
        var d = [{
            ...
            'pcountry': '58CD6215-43ED-4B2F-8EAD-47CA744D6C17',
            ...
            'visatype': 'Local',
            'stdcatagory': '655D878E-6F96-4416-9790-509FFBF862AB',
            'visanumber': '',
            'visaissdt': '',
            'visaexpdt': '',
        ...
        var httpreq = {
            method: 'POST',
            url: 'stdnew_new_offshore.aspx/InsertStudentDetails',
            headers: {
                'Content-Type': 'application/json; charset=utf-8',
                'dataType': 'json'
            },
        ...
        $http(httpreq).success(function (response) {
            ...
            if (data.Status == "1") {
                $scope.TabPanel5_B = false;
                document.location.href = "../redirect/redirectafterreg_offshre.aspx?id=" + data.Student + "&aprtid=" + "";
            }
            else {
